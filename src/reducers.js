...
import resetPasswordEmailLandingFormReducer from './user/resetPasswordEmailLandingFormReducer'
...
const rootReducer = combineReducers({
    ...
    resetPasswordEmailLandingForm: resetPasswordEmailLandingFormReducer
});
